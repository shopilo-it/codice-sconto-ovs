#!/usr/bin/env python3
"""
Recupero codici sconto OVS da shopilo.it
Sursa: https://shopilo.it/negozi/ovs.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/ovs.it"
STORE_NAME = "OVS"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per OVS da shopilo.it"""
    headers = {
